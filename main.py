...
LIVE_MODE_BALANCED_PAIRS = ("BTCUSDT", "ETHUSDT")
LIVE_MODE_AGGRESSIVE_PAIRS = ("BTCUSDT", "ETHUSDT", "SOLUSDT")
LIVE_MODE_CONSERVATIVE_PAIRS = ("BTCUSDT",)
LIVE_MODE_MIN_SCORE = 80
LIVE_MODE_AGGRESSIVE_MIN_SCORE = 78
LIVE_MODE_REGIME_BLOCKLIST = ()
LIVE_MODE_BALANCED_SESSION_UTC = ()
LIVE_MODE_AGGRESSIVE_SESSION_UTC = ()
LIVE_MODE_CONSERVATIVE_SESSION_UTC = ()
...
def _effective_live_mode(settings: Settings) -> EffectiveLiveMode:
    ...
    if mode == "aggressive":
        return EffectiveLiveMode(
            ...
            regime_label_blocklist=LIVE_MODE_REGIME_BLOCKLIST,
            allow_live_regime_gate=True,
            description="BTCUSDT+ETHUSDT+SOLUSDT 24/7 score>=78",
        )
    if mode == "conservative":
        return EffectiveLiveMode(
            ...
            regime_label_blocklist=LIVE_MODE_REGIME_BLOCKLIST,
            allow_live_regime_gate=True,
            description="BTCUSDT 24/7 score>=80",
        )
