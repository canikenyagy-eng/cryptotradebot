...
from core.symbols import MarketType, infer_market_type, split_symbol
...
def score_session_timing(pair: str, signal_time: datetime) -> int:
    ...
    if infer_market_type(pair) != MarketType.FOREX:
        return 10
    _, quote = split_symbol(pair, market_type=MarketType.FOREX)
