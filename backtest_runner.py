...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run an SMC backtest on trading symbols.")
    parser.add_argument("--pairs", default=None, help="Comma-separated symbols, e.g. BTCUSDT,ETHUSDT")
