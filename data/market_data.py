...
from core.symbols import build_symbol_specs, normalize_market_type, normalize_symbol, yahoo_ticker_for_symbol
...
class MarketDataClient:
    ...
    def __init__(
        ...
        symbol_specs: dict[str, object] | None = None,
    ...
    def _normalize_pair(self, pair: str) -> str:
        return yahoo_ticker_for_symbol(pair, market_type=self.market_type)

    @staticmethod
    def _clean_pair(pair: str) -> str:
        clean_pair = normalize_symbol(pair)
        if not clean_pair:
            raise ValueError(f"Unsupported symbol: {pair}")
        return clean_pair
