...
from core.symbols import default_price_unit, normalize_symbol
...
class RealisticExecutionSettings:
    ...
    def pip_size(self, pair: str) -> float:
        return default_price_unit(pair)
    ...
    def sanitized(self) -> "RealisticExecutionSettings":
        ...
        return RealisticExecutionSettings(
            ...
            spread_by_pair={normalize_symbol(k): max(0.0, float(v)) for k, v in self.spread_by_pair.items()},
            slippage_mode=mode,
